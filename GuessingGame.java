...
public class GuessingGame
{
    ...
    public static BTNode<String> beginningTree( )
    {
        ...
        final String ROOT_QUESTION = "Do you have gills?";
        final String LEFT_QUESTION = "Are you bigger than a shark?";
        final String RIGHT_QUESTION = "Do you live underwater?";
        final String ANIMAL1 = "whale";
        final String ANIMAL2 = "sea horse";
        final String ANIMAL3 = "Trout";
        final String ANIMAL4 = "turtle";
